...
public class RS232Connector {
    ...
    private RS232Connector rs232connector = null;
     ...
     * @return
     */
    public RS232Connector getInstance(IoHandlerAdapter receiverHandler) {
     ...
     * @return
     */
    public synchronized RS232Connector getInstance(
    ...
    public synchronized RS232Connector newInstance(
            IoHandlerAdapter receiverHandler, SerialAddress portAddress) {
        if (rs232connector != null) {
    ...
    public RS232Connector(IoHandlerAdapter receiverHandler,
