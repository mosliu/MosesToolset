 ...
 */
package net.liuxuan.Tools.Unitcoverter.base;
...
import net.liuxuan.utils.ResourceManager;
...
public class UnitConverterFactory {
    ...
    public UnitConverterFactory() {
        //net.liuxuan.Tools.Unitcoverter.base
//        conversionTypes = this.loadData("net/liuxuan/Tools/Unitcoverter/base/outputUnitConvert.dat");
        conversionTypes = this.loadData("datafile/outputUnitConvert.dat");
        rebuildAllUnit();
    }
...
//        ucf.saveData(domainData,"outputUnitConvert.dat");
        ...
        List l = ucf.loadData("net/liuxuan/Tools/Unitcoverter/base/outputUnitConvert.dat");
